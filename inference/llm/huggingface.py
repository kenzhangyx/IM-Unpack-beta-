...
class HFLM(LM):
    ...
    def _create_model(
        ...
        **kwargs,
        ...
        # self._model = get_llama(pretrained)
        # print(self._model)
        
        # state_dict = torch.load(os.path.join(kwargs["_ckpt"], "Qmodel.pth"))
        # del kwargs["_ckpt"]
        
        # print(state_dict.keys())
        # print(self._model.load_state_dict(state_dict, strict = False))
        ...
        if "model_num_gpus" in kwargs:
            model_num_gpus = kwargs["model_num_gpus"]
            del kwargs["model_num_gpus"]
        else:
            model_num_gpus = 1
        ...
        if model_num_gpus > 1:
            from .multi_gpu import make_multi_gpu
            make_multi_gpu(self._model, model_num_gpus)
